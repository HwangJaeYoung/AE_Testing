...
public class ViewForMainActivity extends AbstractViewForActivity {
    ...
    private TextView mobiusGetResult;
    ...
    protected void initViews() {
        ...
        mobiusGetResult = (TextView)findViewById(R.id.mobiusGetResult);
    }

    @Override
    protected void setEvent() {
        mobiusButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                controller.getMobiusInformation();
            }
        });
    }
    ...
    public void setMobiusResult(String mobiusResult) {
        mobiusGetResult.setText(mobiusResult);
    }
